...
class SimulationPanel(QtWidgets.QWidget):
    def __init__(
        ...
        *,
        ...
        self.add_batch_set_btn.setToolTip("Add a new batch initial-condition set")
        ...
        self.move_batch_up_btn.setToolTip("Move the active batch set up")
        ...
        self.move_batch_down_btn.setToolTip("Move the active batch set down")
        ...
        self.delete_batch_set_btn.setToolTip("Delete the selected batch set(s)")
