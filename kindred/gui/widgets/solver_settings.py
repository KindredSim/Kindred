...
class SolverSettingsDialog(QtWidgets.QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self._spin_rtol.setMaximumWidth(max_input_width)
        row = QtWidgets.QHBoxLayout()
        ...
        self._spin_atol.setMaximumWidth(max_input_width)
        row = QtWidgets.QHBoxLayout()
        ...
        row = QtWidgets.QHBoxLayout()
        row.addWidget(QtWidgets.QLabel("Max parallel batch workers:", self))
